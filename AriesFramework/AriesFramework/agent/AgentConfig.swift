...
public struct AgentConfig: Codable {
    ...
    /// RAW key generated by ``IndyWallet.generateKey(forConfig:)``. This is the key to open the wallet. It should be stored securely.
    @NotCoded public var walletKey: String?
